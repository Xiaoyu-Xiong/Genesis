...
LOCAL_CONTEXT_ANCHORS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("agent/README.md", ("legacy FEM+IPC-relevant scope overview",)),
    ("agent/docs/ownership.md", ("legacy subagent responsibilities, narrowed to FEM+IPC work",)),
    ("agent/docs/ir_runtime.md", ("IR and runtime semantics for rigid/FEM/IPC interactions",)),
    ("agent/docs/mesh_texture.md", ("mesh generation, repair, texture transfer",)),
    ("agent/docs/generation_and_optimization.md", ("generator, critic, optimization loop",)),
    ("agent/tool_library/runtime_api.py", ("runtime API hints for generated programs",)),
    ("agent/tool_library/constraints/program.py", ("program constraints relevant to rigid/FEM/IPC/articulated scenes")),
    ("agent/runtime/builders.py", ("runtime entity construction examples",)),
    ("agent/runtime/action_dispatch.py", ("action execution semantics",)),
    ("agent/runtime/observation/contacts.py", ("contact observation semantics",)),
    ("agent/runtime/observation/deformable.py", ("FEM/deformable observation semantics")),
...
def _render_markdown(payload: dict[str, Any]) -> str:
    lines = [
        ...
        "Use it as the stable first stop for Genesis FEM+IPC API, solver, asset, rendering, and evaluation context.",
        "",
        "## Source Priority",
        "",
        "1. Prefer local repository source and examples when they conflict with online documentation.",
        "2. Use official Genesis documentation for API intent, parameter names, and FEM+IPC behavior.",
        "3. Use legacy `agent/` files only where they clarify rigid/FEM/IPC, mesh, texture, rendering, or critique.",
        "",
        "## Required Scope",
        "",
    ]
    ...
    lines.extend(
        [
            ...
            "## Role Guidance",
            "",
            "- Planner: use this pack to design complete FEM+IPC plans instead of rigid-only plans.",
            ...
            "",
            "The files below contain the fetched full text for selected FEM+IPC-relevant official documentation pages.",
    ...
    lines.extend(
        [
            ...
            "- The catalog includes only selected FEM+IPC-relevant official documentation links.",
            "",
...
def _scope_policy() -> list[str]:
    return [
        ...
        "Rigid bodies remain in scope as collision partners, tools, projectiles, fixtures, and robot links.",
        "Articulated MJCF/URDF robots remain in scope when they interact with FEM+IPC scenes.",
