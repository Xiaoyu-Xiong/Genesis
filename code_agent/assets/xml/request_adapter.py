...
def xml_prompt_from_request(request: dict[str, Any], task: str) -> str:
    ...
    if size is not None:
        parts.append(
            "Approximate positive XYZ dimensions in meters to bake into MJCF geometry: "
    ...
    if texture_needs:
        parts.append(
            ...
            "Genesis built-in meshes, external meshes, or hfields in the XML."
        )
    parts.append(
        "Mesh geoms are allowed only if the mesh file is generated by this asset worker or is an existing generated "
        "case-workspace asset; otherwise use primitive MJCF geoms."
    )
    parts.append(
