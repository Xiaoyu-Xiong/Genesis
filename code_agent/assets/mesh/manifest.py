...
def manifest_entry_from_bundle(request: dict[str, Any], bundle: Any) -> dict[str, Any]:
    ...
    if genesis_fem_import is not None and genesis_fem_import.ok:
        notes.append("Genesis FEM import validation passed for runtime_path with the listed scale and orientation.")
    elif genesis_fem_import is not None:
        notes.append(f"Genesis FEM import validation failed: {genesis_fem_import.error}")
