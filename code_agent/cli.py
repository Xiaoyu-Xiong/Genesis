...
from code_agent.orchestration.suite import run_suite
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_suite_parser.add_argument("--backend", choices=("cpu", "gpu"), default="cpu")
    ...
    run_suite_parser.add_argument("--codex-mode", choices=("auto", "off", "required"), default="auto")
    run_suite_parser.add_argument("--timeout-sec", type=float, default=CONFIGS.orchestration.execution_timeout_sec)
    run_suite_parser.add_argument("--generation-mode", choices=("codex", "fallback"), default="codex")
