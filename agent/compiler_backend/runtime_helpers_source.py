...
def runtime_helpers_source() -> list[str]:
    return [
        ...
        "    return getattr(entity.__class__, '__name__', '') in {'PBD2DEntity', 'PBD3DEntity', 'PBDParticleEntity', 'PBDFreeParticleEntity'}",
        "",
        "",
        ...
        "    initial_rows = _as_vec3_rows(_to_serializable(getattr(entity, '_particles', None)))",
