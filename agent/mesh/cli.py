...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser_generate.add_argument("--poll-interval-sec", type=float, default=2.0, help="Polling interval in seconds.")
    parser_generate.add_argument(
        "--max-wait-sec",
        type=float,
        default=300.0,
    ...
    parser_generate.add_argument("--timeout-sec", type=float, default=120.0, help="HTTP request timeout.")
    parser_generate.add_argument(
        "--api-key-env",
        type=str,
